...
public class TFIDF_back {
    ...
    public static ArrayList<String> cutWords(String file) throws IOException{
        ...
        String text = TFIDF_back.readFile(file);
    ...
    public static HashMap<String, Float> tf(ArrayList<String> cutwords){
        ...
        HashMap<String, Integer> intTF = TFIDF_back.normalTF(cutwords); 
    ...
    public static HashMap<String, HashMap<String, Integer>> normalTFAllFiles(String dirc) throws IOException{
        ...
        List<String> filelist = TFIDF_back.readDirs(dirc);
        for(String file : filelist){
            HashMap<String, Integer> dict = new HashMap<String, Integer>();
            ArrayList<String> cutwords = TFIDF_back.cutWords(file); //get cut word for one file
            
            dict = TFIDF_back.normalTF(cutwords);
    ...
    public static HashMap<String,HashMap<String, Float>> tfAllFiles(String dirc) throws IOException{
        ...
        for(String file : filelist){
            ...
            ArrayList<String> cutwords = TFIDF_back.cutWords(file); //get cut words for one file
            
            dict = TFIDF_back.tf(cutwords);
            allTF.put(file, dict);
        }
        return allTF;
    }
    ...
    public static void tf_idf(HashMap<String,HashMap<String, Float>> all_tf,HashMap<String, Float> idfs){
        ...
        for(int i = 0; i < docNum; i++){
            ...
            String fileName = FileList.get(i).split("\\.")[0]; 
            
            String identifier = null;
            String tmp[] = fileName.split("\\\\"); 
            if (tmp.length > 1) { 
            	identifier = tmp[tmp.length - 1]; 
            }
...
*/           
    ...
    public static void main(String[] args) throws IOException, SQLException {
         // TODO Auto-generated method stub
      	 ...
      	 String file = "D:/ProgramData/R/culture/files";       
