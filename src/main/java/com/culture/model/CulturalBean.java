...
public class CulturalBean 
{
	...
	private String location;				//地域环境，建筑专用
	
	private String shape;					//器形
	private String pattern;					//纹饰
	private String color;					//色彩
	private String structure;				//结构，建筑专用
	private String decoration;				//装饰，建筑专用
	...
	private String social_history_info;		//社会历史信息，建筑专用
	...
	private int isCheck;					//0：未审核，1:审核通过，2：审核失败
	private String manager;					//录入者
	private String type;					//文物大类，qiwu,zhiwu,jianzhu,bihua
	...
	private List<UploadFile> video;			//视频信息
