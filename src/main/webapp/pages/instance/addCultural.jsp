...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/culture/doctor/dtAdd.do">添加${type}</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="instanceForm" action="/culture/instance/saveCultural.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
									...
									<div class="portlet-body">
		 								<div class="control-group">
											...
											<div class="controls">
												...
												<span id="titleSpan" idclass="help-inline">必填</span>
											</div>
										</div>
		 								<div class="control-group">
	...
	<script>
		...
		//验证概念名字是否存在
		$(function () {//加载事件
            var titleInput = $("#title");//id为用户名文本框id
            //光标离开事件
		...
		function creatSubmitForm(formId){
			return function submitForm(){
			    ...
			    success: function(transport)
			    {
			    	 ...
			    	 if (jresp.isSuccessfully()){
			    		 var identifier = jresp.getMessage();
				    	 var type = $("#type").val();
				    	 ...
				    	 location.href="/culture/instance/addInstance.do?type="+type+"&classification="+classification+"&title="+title+"&used_title="+used_title+"&creator="+creator+"&identifier="+identifier+"&creation_date="+creation_date;
			    	 }
			    },
