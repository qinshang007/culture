				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="instanceForm" action="/culture/instance/saveInstance.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
			...
			return function submitForm(){
			    ...
			    success: function(transport)
			    {
			    	 ...
			    	 if (jresp.isSuccessfully()){
			    		 ...
			    		 location.href="/culture/instance/addCultural.do?type="+type+"&classification="+classification;
			    	 }
			    },
