					...
					<div class="span12">
						...
						<div class="portlet-body form">
							...
							<form id="instanceForm" action="/culture/instance/save.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								...
								<input type="hidden" id="classification" name="classification" value="${classificationname }" />
								<input type="hidden" id="classificationId" name="classificationId" value="${classification }" />
								<div class="portlet box blue">
									...
									<div class="portlet-body">
										...
										<div id="placeOfOriginDiv" class="control-group">
											...
											<div class="controls">										
												<input id="creatoplace_of_originr" type="text" class="span6 m-wrap" name="place_of_origin" />
											</div>
										</div>
										<div class="control-group">
