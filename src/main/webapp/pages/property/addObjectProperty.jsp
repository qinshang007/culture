...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>对象属性</div>
							</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form id="opForm" action="/culture/property/save.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="pfid" class="span6 chosen" data-placeholder="选择父概念" tabindex="1" name="pfid">
											<c:choose>
	...
	<script>
		...
		function submit(){
			...
			var pfname = $("#pfid option:selected").text(); //父属性名字
	    ...
	    type: 'POST',
		    ...
		    success: function(transport)
		    {
		    	 ...
		    	 location.href="/culture/property/addObjectProperty.do?pfid="+pfid+"&pfname="+pfname;
		    },
