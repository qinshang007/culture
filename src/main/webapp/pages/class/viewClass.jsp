...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet-body form">
							...
							<form id="dtForm" action="/culture/doctor/save.do" class="form-horizontal" method="post" enctype="multipart/form-data" target="hidden_frame">
								<input id="cid" type="hidden" name="cid" value="${oc.cid}" />
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="cfid" class="span6 chosen" data-placeholder="选择父概念" tabindex="1" name="cfid">
											<option value="${cfid}">${cfname}</option>
	...
	<script>
		...
		function submit(){
			var URL = "/culture/class/update.do";
			var cid = $("#cid").val();
			var cname = $("#cname").val();
			var cfid = $("#cfid").val();
	        ...
	        url: URL,
	    type: 'POST',
	        data:"cid="+cid+"&cname="+cname+"&cfid="+cfid+"&cfname="+cfname,
