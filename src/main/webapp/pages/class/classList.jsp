...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/culture/class/classList.do?pageStart=1">概念列表</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
							...
							<form class="form-search" action="#">
								<div class="chat-form">
									<div class="input-cont">   
										<input id="title" type="text" placeholder="请输入概念名称..." class="m-wrap" name="title"/>
									</div>
								...
								<tbody>
									<c:forEach  items="${oclist}"  var="item"  varStatus="status">
										<tr class="">
											...
											<td>${item.cname}</td>
											<td><a  href="/culture/class/viewClass.do?cid=${item.cid}" target="_blank">查看</a></td>
											<td><a  href="javascript:deleteClass('${item.cid}','${item.cname}')">删除</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
	...
	<script>
		...
		$("#search").click(function () {
			var title = $("#title").val();
			var url="/culture/class/classList.do?cname="+title+"&pageStart=1";
	      	location.href = url;
		})
